...
#define OS_DHCPD_TASK_PRIO OS_TASK_LOW_PRIO
/* dhcpd task */
...
{
    { "dhcpd_task",  (OsMsgQ)0, 4, OS_DHCPD_TASK_PRIO, 256, NULL, udhcpd_start_task},
};
		...
		uint8_t *requested_ip_opt)
{
    ...
    if(server_config.router_info_en)

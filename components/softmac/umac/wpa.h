...
#define AKM_PSK_SHA256		0x00000004
#define AKM_SAE		0x00000008
...
#define IEEE80211_AKM_PSK_SHA256    MKOUI (0, 0, 0, 0x06)
#define IEEE80211_AKM_SAE           MKOUI (0, 0, 0, 0x08)
...
#define WPA_KDE_IGTK MKOUI(0x00, 0x0F, 0xAC, 0x09)
...
void init_wpa_ctx(u8 wsid, struct wpa_common_ctx *ctx, u8 *pmk);
void deinit_wpa_ctx(struct wpa_common_ctx *ctx);
void init_AP_wpa_ctx(u8 wsid, struct wpa_common_ctx *ctx, u8 *pmk, struct ieee80211_ie_rsn *rsn_ie);
void init_AP_crypto();
void deinit_AP_crypto();
int pack_wpa2 (struct wpa_common_ctx *ctx, u8 *ptr);
int sec80211_detect(struct wpa_common_ctx *ctx, struct ieee802_11_elems *elems, u8 crypto);
...
void tx_wpa_4_of_4 (u8 ifid, struct wpa_common_ctx *ctx, u8 err);
...
int rx_wpa_2_of_4 (u8 wsid, struct wpa_common_ctx *ctx, struct eapol_frame *eap_frame);
void tx_wpa_3_of_4 (struct wpa_common_ctx *ctx);
void gen_pmk(u8 wsid);
#endif

...
int rx_process_wpa (u8 bssid, u8 wsid, struct eapol_frame *eap_frame);
int rx_process_eapol (u8 bssid, u8 wsid, u8 *data, int datalen);
int rx_process_eap (u8 bssid, u8 wsid, u8 *data, int datalen);

...
#define CONFIG_MEMP_DEBUG       LWIP_MEMP_DEBUG_EN
...
/* RAM Usage:
   ...
   3: Customer setting
*/
#define LWIP_PARAM_SET              DEFAULT_LWIP_RESOURCES_PARAMETER
/***********************************************************/
...
//#if defined(ROM_MODE) || defined(BUILD_ROM) || defined(WAC_EN)
#if defined(WAC_EN)
#define LWIP_IPV6                       (1)
#else
#define LWIP_IPV6                       (0)
...
#define LWIP_STATS                  LWIP_MEMP_DEBUG_EN
#define MEMP_OVERFLOW_CHECK         LWIP_MEMP_DEBUG_EN

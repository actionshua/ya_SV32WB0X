...
#ifndef PROJECT_SMAC
#define MBOX_MAX_MSG_EVENT                   74 
#else
#define MBOX_MAX_MSG_EVENT                   32              //(64+10) 64:tx id, 10 for rx // Max message event in the system
#endif

//#define __REG_PRINT__    //direct printf to register to speed up for simulate

//#define CLI_HISTORY_ENABLE			0               // Move to feature.mk 

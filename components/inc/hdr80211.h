...
enum ieee80211_saquery_actioncode {
	WLAN_SA_QUERY_REQ = 0,
	WLAN_SA_QUERY_RESP = 1,
 };
...
#define IS_SUBTYPE_QOSDATA(fc)   IS_EQUAL(FC_STYPE(fc), FST_QOS_DATA)
...
#define HDR80211_MGMT(x)    /*lint -save -e740 */ (HDR80211_Mgmt *)((u8 *)(x)+((struct ssv6006_tx_desc *)(x))->hdr_offset) /*lint -restore */

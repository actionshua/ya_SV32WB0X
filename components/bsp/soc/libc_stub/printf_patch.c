...
{
    int ret = 0;
    log_level_t tag_level;
    if( get_tag_level(tag, &tag_level) != 0 )
    {
        tag_level = LOG_INFO;
        set_tag_level(tag, tag_level);
    }

 ...
 */
int32_t hal_tm_register_irq_handler (TM_ID_E tm_id, isr_func tm_irq_handler);
 ...
 */
int32_t hal_tm_clear_int_sts (TM_ID_E tm_id);
 ...
 * @retval    0                     The operation completed successfully.
 */
int32_t hal_tm_init (TM_ID_E tm_id);
 ...
 * @retval   0                      The operation completed successfully.
 */
int32_t hal_tm_deinit (TM_ID_E tm_id);
 ...
 *                                  If tm_init_value is 0, then the timer is disabled.
 *                                  Contains at least the [0, 4294967295] range.
 *
 * @retval  -20                     The timer has already been started.
 * @retval   -2                     The timer ID was incorrect.
 * @retval    0                     The operation completed successfully.
 */
int32_t hal_tm_enable (TM_ID_E tm_id, TM_MODE_E tm_mode, uint32_t tm_init_value);
 ...
 * @retval   0                      The operation completed successfully.
 */
int32_t hal_tm_disable (TM_ID_E tm_id);
 ...
 * @retval   0                      The operation completed successfully.
 */
int32_t hal_tm_sw_rst (TM_ID_E tm_id);
 ...
 */
int32_t hal_tm_get_init_value (TM_ID_E tm_id);
 ...
 */
int32_t hal_tm_get_mode (TM_ID_E tm_id);
 ...
 */
int32_t hal_tm_get_int_sts (TM_ID_E tm_id);
 ...
 */
int32_t hal_tm_get_int_mask (TM_ID_E tm_id);
 ...
 */
uint32_t hal_tm_get_cur_value (TM_ID_E tm_id);

/**
 * This service set the timer current countdown value.
 *
 * @param   tm_id                   Select a microsecond or millisecond timer ID.
 * @param   tm_set_value            The timer set value.
 *
 * @retval  -2                      The timer ID was incorrect.
 * @retval    0                     The operation completed successfully.
 */
int32_t hal_tm_set_cur_value (TM_ID_E tm_id, uint32_t tm_set_value);
 ...
 */
int32_t hal_tm_get_prescale (TM_ID_E tm_id);
 ...
 * @retval    0                     The operation completed successfully.
 */
int32_t hal_tm_us_delay (uint16_t microseconds);
 ...
 * @retval    0                     The operation completed successfully.
 */
int32_t hal_tm_ms_delay (uint16_t milliseconds);

/**
 * This service begins the timer countdown with prescaler
 *
 * If tm_init_value is 0, then the timer is disabled.
 *
 * @param   tm_id                   Select a microsecond or millisecond timer ID.
 * @param   prescale                prescale for timer
 * @param   tm_init_value           The timer initial value.
 *                                  If tm_init_value is 0, then the timer is disabled.
 *                                  Contains at least the [0, 4294967295] range.
 *
 ...
 * @retval    0                     The operation completed successfully.
 */
void hal_tm_prescale_enable (TM_ID_E tm_id, uint32_t prescale, uint32_t time);

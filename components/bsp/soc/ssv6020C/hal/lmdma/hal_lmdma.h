...
#define LM_MEM_MASK                 (0xF8000000)
#define IS_LOCAL_MEMORY(ADDR)       (!(((unsigned int)(ADDR)) & LM_MEM_MASK))
 ...
 */
typedef void (*LMDMA_ISR) (LMDMA_CHAN_E dma_chan, LMDMA_IE_E dma_int_type);
 ...
 */
int32_t hal_lmdma_register_isr (LMDMA_CHAN_E dma_chan, LMDMA_IE_E dma_int_enable, LMDMA_ISR dma_isr);

/**
 * Initialize the Local Memory DMA hardware.
 */
void hal_lmdma_init (void);

/**
 * Deinitialize the Local Memory DMA hardware.
 */
void hal_lmdma_deinit (void);
 ...
 * @retval    0                         The operation completed successfully.
 */
int32_t hal_lmdma_start (uint8_t *dma_isaddr, uint8_t *dma_esaddr, uint32_t dma_tcnt, LMDMA_CHAN_E dma_chan, LMDMA_TDIR_E dma_tdir, LMDMA_TES_E dma_tes);
 ...
 * @retval   0                          The operation completed successfully.
 */
int32_t hal_lmdma_stop (LMDMA_CHAN_E dma_chan, LMDMA_BLOCKING_MODE_E dma_blocking_mode);
 ...
 * @retval   0                          The operation completed successfully.
 */
int32_t hal_lmdma_reset (LMDMA_CHAN_E dma_chan, LMDMA_BLOCKING_MODE_E dma_blocking_mode);
 ...
 * @retval    0                         The operation completed successfully.
 */
int32_t hal_lmdma_copy32 (uint8_t *dma_isaddr, uint8_t *dma_esaddr, uint32_t cnt, LMDMA_CHAN_E dma_chan, LMDMA_TDIR_E dma_tdir);
 ...
 * @retval    0                         The operation completed successfully.
 */
int32_t hal_lmdma_copy8 (uint8_t *dma_isaddr, uint8_t *dma_esaddr, uint32_t cnt, LMDMA_CHAN_E dma_chan, LMDMA_TDIR_E dma_tdir);
 ...
 */
LMDMA_CHAN_E hal_lmdma_find_free_channel (LMDMA_BLOCKING_MODE_E dma_blocking_mode);
 ...
 */
uint32_t hal_lmdma_get_cfg (void);

/**
 * This service reads the Local Memory DMA Control and Status value.
 *
 * @return  Returns the DMA Control and Status value.
 */
uint32_t hal_lmdma_get_gcsw (void);
 ...
 */
uint32_t hal_lmdma_get_status (LMDMA_CHAN_E dma_chan);

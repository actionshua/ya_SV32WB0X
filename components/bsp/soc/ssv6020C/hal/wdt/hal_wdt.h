 ...
 */
int32_t hal_wdt_register_isr (WDT_ID_E wdt_id, uint32_t wdt_int_cnt_ofs, WDT_ISR wdt_isr);
 ...
 */
int32_t hal_wdt_enable (WDT_ID_E wdt_id,uint32_t wdt_time_cnt);
 ...
 */
int32_t hal_wdt_disable (WDT_ID_E wdt_id);
 ...
 * @retval   0                      The operation completed successfully.
 */
int32_t hal_wdt_kick (WDT_ID_E wdt_id);
 ...
 * @retval   0                      The watchdog timer has been programmed to fire in time ms units.
 */
int32_t hal_wdt_set_time_cnt (WDT_ID_E wdt_id, uint32_t wdt_time_cnt);
 ...
 */
int32_t hal_wdt_get_enable (WDT_ID_E wdt_id);
 ...
 */
int32_t hal_wdt_get_int_cnt_ofs (WDT_ID_E wdt_id);
 ...
 */
int32_t hal_wdt_get_time_cnt (WDT_ID_E wdt_id);
 ...
 */
int32_t hal_wdt_get_reset (WDT_ID_E wdt_id);

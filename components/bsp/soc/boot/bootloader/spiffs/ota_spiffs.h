...
#ifndef OTA_SPIFFS_H_
#define OTA_SPIFFS_H_
 ...
 */
s32_t otaSPIFFS_mount(spiffs *fs, spiffs_config *config, u8_t *work,
 ...
 * @param fs            the file system struct
 */
void otaSPIFFS_unmount(spiffs *fs);
 ...
 */
s32_t otaSPIFFS_creat(spiffs *fs, const char *path, spiffs_mode mode);
 ...
 * @param mode          ignored, for posix compliance
 */
spiffs_file otaSPIFFS_open(spiffs *fs, const char *path, spiffs_flags flags, spiffs_mode mode);
 ...
 * @param mode          ignored, for posix compliance
 */
spiffs_file otaSPIFFS_open_by_dirent(spiffs *fs, struct spiffs_dirent *e, spiffs_flags flags, spiffs_mode mode);
 ...
 * @param mode          ignored, for posix compliance
 */
spiffs_file otaSPIFFS_open_by_page(spiffs *fs, spiffs_page_ix page_ix, spiffs_flags flags, spiffs_mode mode);
 ...
 */
s32_t otaSPIFFS_read(spiffs *fs, spiffs_file fh, void *buf, s32_t len);
 ...
 */
s32_t otaSPIFFS_write(spiffs *fs, spiffs_file fh, void *buf, s32_t len);
 ...
 */
s32_t otaSPIFFS_lseek(spiffs *fs, spiffs_file fh, s32_t offs, int whence);
 ...
 */
s32_t otaSPIFFS_remove(spiffs *fs, const char *path);
 ...
 */
s32_t otaSPIFFS_fremove(spiffs *fs, spiffs_file fh);
 ...
 */
s32_t otaSPIFFS_stat(spiffs *fs, const char *path, spiffs_stat *s);
 ...
 * @param s             the stat struct to populate
 */
s32_t otaSPIFFS_fstat(spiffs *fs, spiffs_file fh, spiffs_stat *s);
 ...
 */
s32_t otaSPIFFS_fflush(spiffs *fs, spiffs_file fh);
 ...
 */
s32_t otaSPIFFS_close(spiffs *fs, spiffs_file fh);
 ...
 */
s32_t otaSPIFFS_rename(spiffs *fs, const char *old, const char *newPath);

/**
 * Returns last error of last file operation.
 * @param fs            the file system struct
 */
s32_t otaSPIFFS_errno(spiffs *fs);

/**
 * Clears last error.
 * @param fs            the file system struct
 */
void otaSPIFFS_clearerr(spiffs *fs);
 ...
 */
spiffs_DIR *otaSPIFFS_opendir(spiffs *fs, const char *name, spiffs_DIR *d);

/**
 * Closes a directory stream
 * @param d             the directory stream to close
 */
s32_t otaSPIFFS_closedir(spiffs_DIR *d);
 ...
 */
struct spiffs_dirent *otaSPIFFS_readdir(spiffs_DIR *d, struct spiffs_dirent *e);

/**
 * Runs a consistency check on given filesystem.
 * @param fs            the file system struct
 */
s32_t otaSPIFFS_check(spiffs *fs);
 ...
 */
s32_t otaSPIFFS_info(spiffs *fs, u32_t *total, u32_t *used);
 ...
 * @param fs            the file system struct
 */
s32_t otaSPIFFS_format(spiffs *fs);

/**
 * Returns nonzero if spiffs is mounted, or zero if unmounted.
 * @param fs            the file system struct
 */
u8_t otaSPIFFS_mounted(spiffs *fs);
 ...
 */
s32_t otaSPIFFS_gc_quick(spiffs *fs, u16_t max_free_pages);
 ...
 */
s32_t otaSPIFFS_gc(spiffs *fs, u32_t size);
 ...
 */
s32_t otaSPIFFS_eof(spiffs *fs, spiffs_file fh);
 ...
 * @param fh            the filehandle of the file to check
 */
s32_t otaSPIFFS_tell(spiffs *fs, spiffs_file fh);
 ...
 */
s32_t otaSPIFFS_set_file_callback_func(spiffs *fs, spiffs_file_callback cb_func);
 ...
 */
u32_t otaSPIFFS_buffer_bytes_for_filedescs(spiffs *fs, u32_t num_descs);

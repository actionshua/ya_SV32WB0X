...
#define	ERASE_64KBLOCK_CMD	0xD8
#define	ERASE_64KBLOCK_TLEN	0x04
#define	ERASE_64KBLOCK_RLEN	0x00
...
#define MANUFACTURER_ID_GIGADEVICE          (0xC8)
...
#define MANUFACTURER_ID_ZETTA               (0xBA)
...
// SPI FLASH FUNCTION
//-------------------------------------------------------------------------------------------------
unsigned ota_flash_init(void);
void ota_flash_sector_erase(unsigned int addr);
void ota_flash_page_program(unsigned int flash_addr, unsigned int flash_len, const unsigned char* src_arr);
void ota_flash_64kblock_erase(unsigned int addr);
void flash_cmd(unsigned char *tx_buf, unsigned int txlen, unsigned char *rx_buf, unsigned int rxlen);

...
#define PRINT_RTLINK_TAG LOG_TAG_RTLINK
...
typedef enum {
    RTStatus_Error = -2,         /**<Status: normal error*/
    RTStatus_Params_Error = -1,  /**<Status: type: parameters error */
    RTStatus_Ok = 0,             /**<Status: normal pass*/
    RTStatus_Params_Ok =1        /**<Status: type: parameters pass */
} RTStatus;
...
typedef struct {
    uint8 (*decCallback)(uint8*, uint8, uint8*); /**< dec data callback*/

...
static inline void btc_ble_mesh_health_client_cb_to_app(ssv_ble_mesh_health_client_cb_event_t event,
        ssv_ble_mesh_health_client_cb_param_t *param)
{
    ssv_ble_mesh_health_client_cb_t btc_ble_mesh_cb =
        (ssv_ble_mesh_health_client_cb_t)btc_profile_cb_get(BTC_PID_HEALTH_CLIENT);
    if (btc_ble_mesh_cb) {
...
void btc_ble_mesh_health_client_arg_deep_copy(btc_msg_t *msg, void *p_dest, void *p_src)
{
    ...
    case BTC_BLE_MESH_ACT_HEALTH_CLIENT_GET_STATE: {
        dst->health_client_get_state.params = (ssv_ble_mesh_client_common_param_t *)osi_malloc(sizeof(ssv_ble_mesh_client_common_param_t));
        dst->health_client_get_state.get_state = (ssv_ble_mesh_health_client_get_state_t *)osi_malloc(sizeof(ssv_ble_mesh_health_client_get_state_t));
        if (dst->health_client_get_state.params && dst->health_client_get_state.get_state) {
            ...
            memcpy(dst->health_client_get_state.get_state, src->health_client_get_state.get_state,
                   sizeof(ssv_ble_mesh_health_client_get_state_t));
        } else {
    ...
    case BTC_BLE_MESH_ACT_HEALTH_CLIENT_SET_STATE: {
        dst->health_client_set_state.params = (ssv_ble_mesh_client_common_param_t *)osi_malloc(sizeof(ssv_ble_mesh_client_common_param_t));
        dst->health_client_set_state.set_state = (ssv_ble_mesh_health_client_set_state_t *)osi_malloc(sizeof(ssv_ble_mesh_health_client_set_state_t));
        if (dst->health_client_set_state.params && dst->health_client_set_state.set_state) {
            ...
            memcpy(dst->health_client_set_state.set_state, src->health_client_set_state.set_state,
                   sizeof(ssv_ble_mesh_health_client_set_state_t));
        } else {
            LOG_ERROR("%s, Failed to allocate memory, act %d", __func__, msg->act);
        }
        break;
...
{
    ssv_ble_mesh_health_client_cb_param_t *p_dest_data = (ssv_ble_mesh_health_client_cb_param_t *)p_dest;
    ssv_ble_mesh_health_client_cb_param_t *p_src_data = (ssv_ble_mesh_health_client_cb_param_t *)p_src;
    u16_t length;
    ...
    switch (msg->act) {
    case SSV_BLE_MESH_HEALTH_CLIENT_GET_STATE_EVT:
    case SSV_BLE_MESH_HEALTH_CLIENT_SET_STATE_EVT:
    case SSV_BLE_MESH_HEALTH_CLIENT_PUBLISH_EVT:
        if (p_src_data->params) {
    ...
    case SSV_BLE_MESH_HEALTH_CLIENT_TIMEOUT_EVT:
        break;
    default:
        break;
    }
...
{
    ssv_ble_mesh_health_client_cb_param_t *arg = NULL;
    ...
    arg = (ssv_ble_mesh_health_client_cb_param_t *)(msg->arg);
...
static void btc_ble_mesh_health_client_callback(ssv_ble_mesh_health_client_cb_param_t *cb_params, uint8_t act)
{
    btc_msg_t msg = {0};
    ...
    btc_transfer_context(&msg, cb_params,
                         sizeof(ssv_ble_mesh_health_client_cb_param_t), btc_ble_mesh_health_client_copy_req_data);
}
...
{
    ssv_ble_mesh_health_client_cb_param_t cb_params = {0};
    ...
    case BTC_BLE_MESH_EVT_HEALTH_CLIENT_GET_STATE:
        act = SSV_BLE_MESH_HEALTH_CLIENT_GET_STATE_EVT;
        break;
    case BTC_BLE_MESH_EVT_HEALTH_CLIENT_SET_STATE:
        act = SSV_BLE_MESH_HEALTH_CLIENT_SET_STATE_EVT;
        break;
    case BTC_BLE_MESH_EVT_HEALTH_CLIENT_PUBLISH:
        act = SSV_BLE_MESH_HEALTH_CLIENT_PUBLISH_EVT;
        break;
    case BTC_BLE_MESH_EVT_HEALTH_CLIENT_TIMEOUT:
        act = SSV_BLE_MESH_HEALTH_CLIENT_TIMEOUT_EVT;
        break;
    default:
...
static int btc_ble_mesh_health_client_get_state(ssv_ble_mesh_client_common_param_t *params,
        ssv_ble_mesh_health_client_get_state_t *get,
        ssv_ble_mesh_health_client_cb_param_t *cb)
{
    ...
    case SSV_BLE_MESH_MODEL_OP_ATTENTION_GET:
        return (cb->error_code = bt_mesh_health_attention_get(&ctx));
    case SSV_BLE_MESH_MODEL_OP_HEALTH_PERIOD_GET:
        return (cb->error_code = bt_mesh_health_period_get(&ctx));
    case SSV_BLE_MESH_MODEL_OP_HEALTH_FAULT_GET:
...
static int btc_ble_mesh_health_client_set_state(ssv_ble_mesh_client_common_param_t *params,
        ssv_ble_mesh_health_client_set_state_t *set,
        ssv_ble_mesh_health_client_cb_param_t *cb)
{
    struct bt_mesh_msg_ctx ctx = {0};
...
{
    btc_ble_mesh_health_client_args_t *arg = NULL;
    ssv_ble_mesh_health_client_cb_param_t cb = {0};
    ...
    case BTC_BLE_MESH_ACT_HEALTH_CLIENT_GET_STATE: {
        ...
        if (cb.error_code) {
            ...
            btc_ble_mesh_health_client_callback(&cb, SSV_BLE_MESH_HEALTH_CLIENT_GET_STATE_EVT);
        }
        break;
    }
    case BTC_BLE_MESH_ACT_HEALTH_CLIENT_SET_STATE: {
        ...
        if (cb.error_code) {
            /* If send failed, callback error_code to app layer immediately */
            btc_ble_mesh_health_client_callback(&cb, SSV_BLE_MESH_HEALTH_CLIENT_SET_STATE_EVT);
        }
        break;
    }
    default:
...
{
    ssv_ble_mesh_health_client_cb_param_t *param = NULL;
    ...
    param = (ssv_ble_mesh_health_client_cb_param_t *)(msg->arg);

    if (msg->act < SSV_BLE_MESH_HEALTH_CLIENT_EVT_MAX) {
...
static inline void btc_ble_mesh_health_server_cb_to_app(ssv_ble_mesh_health_server_cb_event_t event,
        ssv_ble_mesh_health_server_cb_param_t *param)
{
    ssv_ble_mesh_health_server_cb_t btc_ble_mesh_cb =
        (ssv_ble_mesh_health_server_cb_t)btc_profile_cb_get(BTC_PID_HEALTH_SERVER);
    if (btc_ble_mesh_cb) {
        btc_ble_mesh_cb(event, param);
    }
}
...
static void btc_ble_mesh_health_server_copy_req_data(btc_msg_t *msg, void *p_dest, void *p_src)
{
    ...
    switch (msg->act) {
    case SSV_BLE_MESH_HEALTH_SERVER_FAULT_UPDATE_COMP_EVT:
        break;
    default:
        break;
    }
...
static void btc_ble_mesh_health_server_callback(ssv_ble_mesh_health_server_cb_param_t *cb_params, uint8_t act)
{
    btc_msg_t msg = {0};
    ...
    btc_transfer_context(&msg, cb_params,
                         sizeof(ssv_ble_mesh_health_server_cb_param_t), btc_ble_mesh_health_server_copy_req_data);
}
...
void btc_ble_mesh_health_server_call_handler(btc_msg_t *msg)
{
    ...
    case BTC_BLE_MESH_ACT_HEALTH_SERVER_FAULT_UPDATE:
        ...
        btc_ble_mesh_health_server_callback(&param, SSV_BLE_MESH_HEALTH_SERVER_FAULT_UPDATE_COMP_EVT);
        break;
    default:
        break;
    }
...
{
    ssv_ble_mesh_health_server_cb_param_t *param = NULL;
    ...
    param = (ssv_ble_mesh_health_server_cb_param_t *)(msg->arg);

    if (msg->act < SSV_BLE_MESH_HEALTH_SERVER_EVT_MAX) {
...
void btc_ble_mesh_health_server_fault_clear(struct bt_mesh_model *model, u16_t company_id)
{
    ssv_ble_mesh_health_server_cb_param_t param;
    memset(&param, 0, sizeof(param));
    param.fault_clear.model = (ssv_ble_mesh_model_t *)model;
    param.fault_clear.company_id = company_id;

    btc_ble_mesh_health_server_callback(&param, SSV_BLE_MESH_HEALTH_SERVER_FAULT_CLEAR_EVT);
}
...
void btc_ble_mesh_health_server_fault_test(struct bt_mesh_model *model, u8_t test_id, u16_t company_id)
{
    ssv_ble_mesh_health_server_cb_param_t param;
    memset(&param, 0, sizeof(param));
    param.fault_test.model = (ssv_ble_mesh_model_t *)model;
    param.fault_test.test_id = test_id;
    param.fault_test.company_id = company_id;

    btc_ble_mesh_health_server_callback(&param, SSV_BLE_MESH_HEALTH_SERVER_FAULT_TEST_EVT);
}
...
void btc_ble_mesh_health_server_attention_on(struct bt_mesh_model *model, u8_t time)
{
    ssv_ble_mesh_health_server_cb_param_t param;
    memset(&param, 0, sizeof(param));
    param.attention_on.model = (ssv_ble_mesh_model_t *)model;
    param.attention_on.time = time;

    btc_ble_mesh_health_server_callback(&param, SSV_BLE_MESH_HEALTH_SERVER_ATTENTION_ON_EVT);
}
...
void btc_ble_mesh_health_server_attention_off(struct bt_mesh_model *model)
{
    ssv_ble_mesh_health_server_cb_param_t param;
    memset(&param, 0, sizeof(param));
    param.attention_off.model = (ssv_ble_mesh_model_t *)model;

    btc_ble_mesh_health_server_callback(&param, SSV_BLE_MESH_HEALTH_SERVER_ATTENTION_OFF_EVT);
}

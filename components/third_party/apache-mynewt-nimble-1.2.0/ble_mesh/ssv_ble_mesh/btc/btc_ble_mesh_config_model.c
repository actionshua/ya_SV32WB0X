...
static inline void btc_ble_mesh_config_client_cb_to_app(ssv_ble_mesh_cfg_client_cb_event_t event,
        ssv_ble_mesh_cfg_client_cb_param_t *param)
{
    ssv_ble_mesh_cfg_client_cb_t btc_ble_mesh_cb =
        (ssv_ble_mesh_cfg_client_cb_t)btc_profile_cb_get(BTC_PID_CONFIG_CLIENT);
    if (btc_ble_mesh_cb) {
...
void btc_ble_mesh_config_client_arg_deep_copy(btc_msg_t *msg, void *p_dest, void *p_src)
{
    ...
    case BTC_BLE_MESH_ACT_CONFIG_CLIENT_GET_STATE: {
        dst->cfg_client_get_state.params = (ssv_ble_mesh_client_common_param_t *)osi_malloc(sizeof(ssv_ble_mesh_client_common_param_t));
        dst->cfg_client_get_state.get_state = (ssv_ble_mesh_cfg_client_get_state_t *)osi_malloc(sizeof(ssv_ble_mesh_cfg_client_get_state_t));
        if (dst->cfg_client_get_state.params && dst->cfg_client_get_state.get_state) {
            memcpy(dst->cfg_client_get_state.params, src->cfg_client_get_state.params,
                   sizeof(ssv_ble_mesh_client_common_param_t));
            memcpy(dst->cfg_client_get_state.get_state, src->cfg_client_get_state.get_state,
                   sizeof(ssv_ble_mesh_cfg_client_get_state_t));
        } else {
    ...
    case BTC_BLE_MESH_ACT_CONFIG_CLIENT_SET_STATE: {
        dst->cfg_client_set_state.params = (ssv_ble_mesh_client_common_param_t *)osi_malloc(sizeof(ssv_ble_mesh_client_common_param_t));
        dst->cfg_client_set_state.set_state = (ssv_ble_mesh_cfg_client_set_state_t *)osi_malloc(sizeof(ssv_ble_mesh_cfg_client_set_state_t));
        if (dst->cfg_client_set_state.params && dst->cfg_client_set_state.set_state) {
            ...
            memcpy(dst->cfg_client_set_state.set_state, src->cfg_client_set_state.set_state,
                   sizeof(ssv_ble_mesh_cfg_client_set_state_t));
        } else {
            LOG_ERROR("%s, Failed to allocate memory, act %d", __func__, msg->act);
        }
        break;
...
{
    ssv_ble_mesh_cfg_client_cb_param_t *p_dest_data = (ssv_ble_mesh_cfg_client_cb_param_t *)p_dest;
    ssv_ble_mesh_cfg_client_cb_param_t *p_src_data = (ssv_ble_mesh_cfg_client_cb_param_t *)p_src;
    u16_t length;
    ...
    if (p_src_data->params) {
        p_dest_data->params = osi_malloc(sizeof(ssv_ble_mesh_client_common_param_t));
        if (!p_dest_data->params) {
            LOG_ERROR("%s, Failed to allocate memory, act %d", __func__, msg->act);
            return;
        }

        memcpy(p_dest_data->params, p_src_data->params, sizeof(ssv_ble_mesh_client_common_param_t));
    }
...
{
    ssv_ble_mesh_cfg_client_cb_param_t *arg = NULL;
    ...
    arg = (ssv_ble_mesh_cfg_client_cb_param_t *)(msg->arg);
...
static void btc_ble_mesh_config_client_callback(ssv_ble_mesh_cfg_client_cb_param_t *cb_params, uint8_t act)
{
    btc_msg_t msg = {0};
    ...
    btc_transfer_context(&msg, cb_params,
                         sizeof(ssv_ble_mesh_cfg_client_cb_param_t), btc_ble_mesh_config_client_copy_req_data);
}
...
{
    ssv_ble_mesh_cfg_client_cb_param_t cb_params = {0};
    ssv_ble_mesh_client_common_param_t params = {0};
    size_t length;
    uint8_t act;
    ...
    case BTC_BLE_MESH_EVT_CONFIG_CLIENT_GET_STATE:
        act = SSV_BLE_MESH_CFG_CLIENT_GET_STATE_EVT;
        break;
    case BTC_BLE_MESH_EVT_CONFIG_CLIENT_SET_STATE:
        act = SSV_BLE_MESH_CFG_CLIENT_SET_STATE_EVT;
        break;
    case BTC_BLE_MESH_EVT_CONFIG_CLIENT_PUBLISH:
        act = SSV_BLE_MESH_CFG_CLIENT_PUBLISH_EVT;
        break;
    case BTC_BLE_MESH_EVT_CONFIG_CLIENT_TIMEOUT:
        act = SSV_BLE_MESH_CFG_CLIENT_TIMEOUT_EVT;
        break;
    default:
    ...
    params.model = (ssv_ble_mesh_model_t *)model;
...
static int btc_ble_mesh_config_client_get_state(ssv_ble_mesh_client_common_param_t *params,
        ssv_ble_mesh_cfg_client_get_state_t *get,
        ssv_ble_mesh_cfg_client_cb_param_t *cb)
{
...
static int btc_ble_mesh_config_client_set_state(ssv_ble_mesh_client_common_param_t *params,
        ssv_ble_mesh_cfg_client_set_state_t *set,
        ssv_ble_mesh_cfg_client_cb_param_t *cb)
{
    struct bt_mesh_msg_ctx ctx = {0};
    ...
    case SSV_BLE_MESH_MODEL_OP_NODE_RESET:
        return (cb->error_code = bt_mesh_cfg_node_reset(&ctx));
    case SSV_BLE_MESH_MODEL_OP_MODEL_PUB_VIRTUAL_ADDR_SET: {
        struct bt_mesh_cfg_mod_pub model_pub = {
    ...
    case SSV_BLE_MESH_MODEL_OP_MODEL_SUB_DELETE_ALL:
        return (cb->error_code =
    ...
    case SSV_BLE_MESH_MODEL_OP_KEY_REFRESH_PHASE_SET:
        return (cb->error_code =
                    bt_mesh_cfg_kr_phase_set(&ctx, set->kr_phase_set.net_idx,
                                             set->kr_phase_set.transition));
    case SSV_BLE_MESH_MODEL_OP_NETWORK_TRANSMIT_SET:
        return (cb->error_code =
...
{
    btc_ble_mesh_config_client_args_t *arg = NULL;
    ssv_ble_mesh_cfg_client_cb_param_t cb = {0};
    ...
    case BTC_BLE_MESH_ACT_CONFIG_CLIENT_GET_STATE: {
        ...
        btc_ble_mesh_config_client_get_state(arg->cfg_client_get_state.params,
                                             ...
                                             &cb);
        if (cb.error_code) {
            btc_ble_mesh_config_client_callback(&cb, SSV_BLE_MESH_CFG_CLIENT_GET_STATE_EVT);
        }
        break;
    }
    case BTC_BLE_MESH_ACT_CONFIG_CLIENT_SET_STATE: {
        ...
        btc_ble_mesh_config_client_set_state(arg->cfg_client_set_state.params,
                                             ...
                                             &cb);
        if (cb.error_code) {
            btc_ble_mesh_config_client_callback(&cb, SSV_BLE_MESH_CFG_CLIENT_SET_STATE_EVT);
        }
        break;
    }
    default:
...
{
    ssv_ble_mesh_cfg_client_cb_param_t *param = NULL;
    ...
    param = (ssv_ble_mesh_cfg_client_cb_param_t *)(msg->arg);

    if (msg->act < SSV_BLE_MESH_CFG_CLIENT_EVT_MAX) {
...
static inline void btc_ble_mesh_config_server_cb_to_app(ssv_ble_mesh_cfg_server_cb_event_t event,
        ssv_ble_mesh_cfg_server_cb_param_t *param)
{
    ssv_ble_mesh_cfg_server_cb_t btc_ble_mesh_cb =
        (ssv_ble_mesh_cfg_server_cb_t)btc_profile_cb_get(BTC_PID_CONFIG_SERVER);
    if (btc_ble_mesh_cb) {
        btc_ble_mesh_cb(event, param);
    }
}

static void btc_ble_mesh_config_server_callback(ssv_ble_mesh_cfg_server_cb_param_t *cb_params, uint8_t act)
{
    btc_msg_t msg = {0};
    ...
    btc_transfer_context(&msg, cb_params, sizeof(ssv_ble_mesh_cfg_server_cb_param_t), NULL);
}
...
void bt_mesh_config_server_cb_evt_to_btc(u8_t evt_type,
        ...
        const u8_t *val, size_t len)
{
    ssv_ble_mesh_cfg_server_cb_param_t cb_params = {0};
    size_t length;
    uint8_t act;
    ...
    case BTC_BLE_MESH_EVT_CONFIG_SERVER_STATE_CHANGE:
        act = SSV_BLE_MESH_CFG_SERVER_STATE_CHANGE_EVT;
        break;
    default:
    ...
    cb_params.model = (ssv_ble_mesh_model_t *)model;
...
{
    ssv_ble_mesh_cfg_server_cb_param_t *param = NULL;
    ...
    param = (ssv_ble_mesh_cfg_server_cb_param_t *)(msg->arg);

    if (msg->act < SSV_BLE_MESH_CFG_SERVER_EVT_MAX) {

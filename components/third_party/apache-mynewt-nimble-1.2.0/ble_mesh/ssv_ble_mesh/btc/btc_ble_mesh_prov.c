...
static inline void btc_ble_mesh_prov_cb_to_app(ssv_ble_mesh_prov_cb_event_t event,
        ssv_ble_mesh_prov_cb_param_t *param)
{
    ssv_ble_mesh_prov_cb_t btc_ble_mesh_cb =
        (ssv_ble_mesh_prov_cb_t)btc_profile_cb_get(BTC_PID_PROV);
    if (btc_ble_mesh_cb) {
        btc_ble_mesh_cb(event, param);
    }
}

static inline void btc_ble_mesh_model_cb_to_app(ssv_ble_mesh_model_cb_event_t event,
        ssv_ble_mesh_model_cb_param_t *param)
{
    ssv_ble_mesh_model_cb_t btc_ble_mesh_cb =
        (ssv_ble_mesh_model_cb_t)btc_profile_cb_get(BTC_PID_MODEL);
    if (btc_ble_mesh_cb) {
        btc_ble_mesh_cb(event, param);
    }
}
...
void btc_ble_mesh_model_arg_deep_copy(btc_msg_t *msg, void *p_dest, void *p_src)
{
    ...
    case BTC_BLE_MESH_ACT_CLIENT_MODEL_SEND: {
        ...
        dst->model_send.ctx = osi_malloc(sizeof(ssv_ble_mesh_msg_ctx_t));
        ...
        if (dst->model_send.ctx) {
            memcpy(dst->model_send.ctx, src->model_send.ctx, sizeof(ssv_ble_mesh_msg_ctx_t));
        } else {
            LOG_ERROR("%s, Failed to allocate memory, act %d", __func__, msg->act);
        }
        break;
    ...
    case BTC_BLE_MESH_ACT_SERVER_MODEL_UPDATE_STATE:
        ...
        dst->model_update_state.value = osi_malloc(sizeof(ssv_ble_mesh_server_state_value_t));
        if (dst->model_update_state.value) {
            memcpy(dst->model_update_state.value, src->model_update_state.value,
                   sizeof(ssv_ble_mesh_server_state_value_t));
        } else {
            LOG_ERROR("%s, Failed to allocate memory, act %d", __func__, msg->act);
        }
        break;
...
{
    ssv_ble_mesh_model_cb_param_t *p_dest_data = (ssv_ble_mesh_model_cb_param_t *)p_dest;
    ssv_ble_mesh_model_cb_param_t *p_src_data = (ssv_ble_mesh_model_cb_param_t *)p_src;
    ...
    case SSV_BLE_MESH_MODEL_OPERATION_EVT: {
        if (p_src_data->model_operation.ctx && p_src_data->model_operation.msg) {
            p_dest_data->model_operation.ctx = osi_malloc(sizeof(ssv_ble_mesh_msg_ctx_t));
            ...
            if (p_dest_data->model_operation.ctx) {
                memcpy(p_dest_data->model_operation.ctx, p_src_data->model_operation.ctx, sizeof(ssv_ble_mesh_msg_ctx_t));
            } else {
                LOG_ERROR("%s, Failed to allocate memory, act %d", __func__, msg->act);
            }
    ...
    case SSV_BLE_MESH_CLIENT_MODEL_RECV_PUBLISH_MSG_EVT: {
        if (p_src_data->client_recv_publish_msg.ctx && p_src_data->client_recv_publish_msg.msg) {
            p_dest_data->client_recv_publish_msg.ctx = osi_malloc(sizeof(ssv_ble_mesh_msg_ctx_t));
            ...
            if (p_dest_data->client_recv_publish_msg.ctx) {
                memcpy(p_dest_data->client_recv_publish_msg.ctx, p_src_data->client_recv_publish_msg.ctx, sizeof(ssv_ble_mesh_msg_ctx_t));
            } else {
                LOG_ERROR("%s, Failed to allocate memory, act %d", __func__, msg->act);
            }
    ...
    case SSV_BLE_MESH_MODEL_SEND_COMP_EVT: {
        if (p_src_data->model_send_comp.ctx) {
            p_dest_data->model_send_comp.ctx = osi_malloc(sizeof(ssv_ble_mesh_msg_ctx_t));
            if (p_dest_data->model_send_comp.ctx) {
                memcpy(p_dest_data->model_send_comp.ctx, p_src_data->model_send_comp.ctx, sizeof(ssv_ble_mesh_msg_ctx_t));
            } else {
                LOG_ERROR("%s, Failed to allocate memory, act %d", __func__, msg->act);
            }
        }
    ...
    case SSV_BLE_MESH_CLIENT_MODEL_SEND_TIMEOUT_EVT: {
        if (p_src_data->client_send_timeout.ctx) {
            p_dest_data->client_send_timeout.ctx = osi_malloc(sizeof(ssv_ble_mesh_msg_ctx_t));
            if (p_dest_data->client_send_timeout.ctx) {
                memcpy(p_dest_data->client_send_timeout.ctx, p_src_data->client_send_timeout.ctx, sizeof(ssv_ble_mesh_msg_ctx_t));
            } else {
                LOG_ERROR("%s, Failed to allocate memory, act %d", __func__, msg->act);
            }
        }
...
{
    ssv_ble_mesh_model_cb_param_t *arg = NULL;
    ...
    arg = (ssv_ble_mesh_model_cb_param_t *)(msg->arg);
...
static bt_status_t btc_ble_mesh_model_callback(ssv_ble_mesh_model_cb_param_t *param, uint8_t act)
{
    btc_msg_t msg = {0};
    bt_status_t ret;
    ...
    ret = btc_transfer_context(&msg, param,
                               sizeof(ssv_ble_mesh_model_cb_param_t), btc_ble_mesh_model_copy_req_data);
...
{
    ssv_ble_mesh_model_cb_param_t mesh_param;
    memset(&mesh_param, 0, sizeof(mesh_param));
    mesh_param.model_operation.opcode = ctx->recv_op;
    mesh_param.model_operation.model = (ssv_ble_mesh_model_t *)model;
    mesh_param.model_operation.ctx = (ssv_ble_mesh_msg_ctx_t *)ctx;
    mesh_param.model_operation.length = buf->len;
    mesh_param.model_operation.msg = buf->data;

    btc_ble_mesh_model_callback(&mesh_param, SSV_BLE_MESH_MODEL_OPERATION_EVT);
    return;
}
        ...
        struct net_buf_simple *buf)
{
    ...
    if (node == NULL) {
        ...
        mesh_param.client_recv_publish_msg.model = (ssv_ble_mesh_model_t *)model;
        mesh_param.client_recv_publish_msg.ctx = (ssv_ble_mesh_msg_ctx_t *)ctx;
        mesh_param.client_recv_publish_msg.length = buf->len;
        mesh_param.client_recv_publish_msg.msg = buf->data;
        btc_ble_mesh_model_callback(&mesh_param, SSV_BLE_MESH_CLIENT_MODEL_RECV_PUBLISH_MSG_EVT);
    } else {
        mesh_param.model_operation.opcode = ctx->recv_op;
        mesh_param.model_operation.model = (ssv_ble_mesh_model_t *)model;
        mesh_param.model_operation.ctx = (ssv_ble_mesh_msg_ctx_t *)ctx;
...
static void btc_ble_mesh_client_model_timeout_cb(struct k_work *work)
{
    ...
    if (timer && !k_delayed_work_free(timer)) {
        ...
        if (node) {
            ...
            mesh_param.client_send_timeout.model = (ssv_ble_mesh_model_t *)node->ctx.model;
            mesh_param.client_send_timeout.ctx = (ssv_ble_mesh_msg_ctx_t *)&node->ctx;
            btc_ble_mesh_model_callback(&mesh_param, SSV_BLE_MESH_CLIENT_MODEL_SEND_TIMEOUT_EVT);
            // Don't forget to release the node at the end.
            bt_mesh_client_free_node(node);
        }
    }
...
static void btc_ble_mesh_model_send_comp_cb(ssv_ble_mesh_model_t *model, ssv_ble_mesh_msg_ctx_t *ctx, u32_t opcode, int err)
{
    ssv_ble_mesh_model_cb_param_t mesh_param;
    memset(&mesh_param, 0, sizeof(mesh_param));
    ...
    btc_ble_mesh_model_callback(&mesh_param, SSV_BLE_MESH_MODEL_SEND_COMP_EVT);
    return;
}

static void btc_ble_mesh_model_publish_comp_cb(ssv_ble_mesh_model_t *model, int err)
{
    ssv_ble_mesh_model_cb_param_t mesh_param ;
    memset(&mesh_param, 0, sizeof(mesh_param));
    ...
    btc_ble_mesh_model_callback(&mesh_param, SSV_BLE_MESH_MODEL_PUBLISH_COMP_EVT);
    return;
}
...
static int btc_ble_mesh_model_publish_update(struct bt_mesh_model *mod)
{
    ...
    LOG_DEBUG("%s", __func__);
    memset(&mesh_param, 0, sizeof(mesh_param));
    mesh_param.model_publish_update.model = (ssv_ble_mesh_model_t *)mod;

    ret = btc_ble_mesh_model_callback(&mesh_param, SSV_BLE_MESH_MODEL_PUBLISH_UPDATE_EVT);
    return (ret == BT_STATUS_SUCCESS) ? 0 : -1;
}

static void btc_ble_mesh_server_model_update_state_comp_cb(ssv_ble_mesh_model_t *model,
        ssv_ble_mesh_server_state_type_t type, int err)
{
    ssv_ble_mesh_model_cb_param_t mesh_param;
    memset(&mesh_param, 0, sizeof(mesh_param));
    ...
    btc_ble_mesh_model_callback(&mesh_param, SSV_BLE_MESH_SERVER_MODEL_UPDATE_STATE_COMP_EVT);
    return;
}

static bt_status_t btc_ble_mesh_prov_callback(ssv_ble_mesh_prov_cb_param_t *param, uint8_t act)
{
    btc_msg_t msg = {0};
    bt_status_t ret;
    ...
    ret = btc_transfer_context(&msg, param, sizeof(ssv_ble_mesh_prov_cb_param_t), NULL);
    if (ret != BT_STATUS_SUCCESS) {
        LOG_ERROR("%s, btc_transfer_context failed", __func__);
    }
    return ret;
...
static void btc_ble_mesh_oob_pub_key_cb(void)
{
    ...
    btc_ble_mesh_prov_callback(NULL, SSV_BLE_MESH_NODE_PROV_OOB_PUB_KEY_EVT);
    return;
}

static int btc_ble_mesh_output_number_cb(bt_mesh_output_action_t act, u32_t num)
{
    ssv_ble_mesh_prov_cb_param_t mesh_param;
    bt_status_t ret;

    LOG_DEBUG("%s", __func__);
    memset(&mesh_param, 0, sizeof(mesh_param));
    mesh_param.node_prov_output_num.action = (ssv_ble_mesh_output_action_t)act;
    mesh_param.node_prov_output_num.number = num;

    ret = btc_ble_mesh_prov_callback(&mesh_param, SSV_BLE_MESH_NODE_PROV_OUTPUT_NUMBER_EVT);
    return (ret == BT_STATUS_SUCCESS) ? 0 : -1;
}
...
static int btc_ble_mesh_output_string_cb(const char *str)
{
    ...
    ret = btc_ble_mesh_prov_callback(&mesh_param, SSV_BLE_MESH_NODE_PROV_OUTPUT_STRING_EVT);
    return (ret == BT_STATUS_SUCCESS) ? 0 : -1;
}
...
static int btc_ble_mesh_input_cb(bt_mesh_input_action_t act, u8_t size)
{
    ...
    LOG_DEBUG("%s", __func__);
    memset(&mesh_param, 0, sizeof(mesh_param));
    mesh_param.node_prov_input.action = (ssv_ble_mesh_input_action_t)act;
    mesh_param.node_prov_input.size = size;

    ret = btc_ble_mesh_prov_callback(&mesh_param, SSV_BLE_MESH_NODE_PROV_INPUT_EVT);
    return (ret == BT_STATUS_SUCCESS) ? 0 : -1;
}
...
static void btc_ble_mesh_link_open_cb(bt_mesh_prov_bearer_t bearer)
{
    ...
    LOG_DEBUG("%s", __func__);
    memset(&mesh_param, 0, sizeof(mesh_param));
    mesh_param.node_prov_link_open.bearer = (ssv_ble_mesh_prov_bearer_t)bearer;

    btc_ble_mesh_prov_callback(&mesh_param, SSV_BLE_MESH_NODE_PROV_LINK_OPEN_EVT);
    return;
}
...
static void btc_ble_mesh_link_close_cb(bt_mesh_prov_bearer_t bearer)
{
    ...
    LOG_DEBUG("%s", __func__);
    memset(&mesh_param, 0, sizeof(mesh_param));
    mesh_param.node_prov_link_close.bearer = (ssv_ble_mesh_prov_bearer_t)bearer;

    btc_ble_mesh_prov_callback(&mesh_param, SSV_BLE_MESH_NODE_PROV_LINK_CLOSE_EVT);
    return;
}
...
static void btc_ble_mesh_complete_cb(u16_t net_idx, const u8_t net_key[16], u16_t addr, u8_t flags, u32_t iv_index)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, SSV_BLE_MESH_NODE_PROV_COMPLETE_EVT);
    return;
}
...
static void btc_ble_mesh_reset_cb(void)
{
    ...
    btc_ble_mesh_prov_callback(NULL, SSV_BLE_MESH_NODE_PROV_RESET_EVT);
    return;
}
...
static void btc_ble_mesh_prov_register_complete_cb(int err_code)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, SSV_BLE_MESH_PROV_REGISTER_COMP_EVT);
    return;
}

static void btc_ble_mesh_prov_set_complete_cb(ssv_ble_mesh_prov_cb_param_t *param, uint8_t act)
{
    LOG_DEBUG("%s", __func__);
    ...
    u16_t oob_info, bt_mesh_prov_bearer_t bearer)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, SSV_BLE_MESH_PROVISIONER_RECV_UNPROV_ADV_PKT_EVT);
    return;
}
...
static int btc_ble_mesh_provisioner_prov_read_oob_pub_key_cb(u8_t link_idx)
{
    ...
    ret = btc_ble_mesh_prov_callback(&mesh_param, SSV_BLE_MESH_PROVISIONER_PROV_READ_OOB_PUB_KEY_EVT);
    return (ret == BT_STATUS_SUCCESS) ? 0 : -1;
}
        ...
        bt_mesh_output_action_t act, u8_t size, u8_t link_idx)
{
    ...
    LOG_DEBUG("%s", __func__);
    memset(&mesh_param, 0, sizeof(mesh_param));
    mesh_param.provisioner_prov_input.method = (ssv_ble_mesh_oob_method_t)method;
    mesh_param.provisioner_prov_input.action = (ssv_ble_mesh_output_action_t)act;
    mesh_param.provisioner_prov_input.size = size;
    mesh_param.provisioner_prov_input.link_idx = link_idx;

    ret = btc_ble_mesh_prov_callback(&mesh_param, SSV_BLE_MESH_PROVISIONER_PROV_INPUT_EVT);
    return (ret == BT_STATUS_SUCCESS) ? 0 : -1;
}
        ...
        bt_mesh_input_action_t act, void *data, u8_t size, u8_t link_idx)
{
    ...
    LOG_DEBUG("%s", __func__);
    memset(&mesh_param, 0, sizeof(mesh_param));
    mesh_param.provisioner_prov_output.method = (ssv_ble_mesh_oob_method_t)method;
    mesh_param.provisioner_prov_output.action = (ssv_ble_mesh_input_action_t)act;
    ...
    ret = btc_ble_mesh_prov_callback(&mesh_param, SSV_BLE_MESH_PROVISIONER_PROV_OUTPUT_EVT);
    return (ret == BT_STATUS_SUCCESS) ? 0 : -1;
}
...
static void btc_ble_mesh_provisioner_link_open_cb(bt_mesh_prov_bearer_t bearer)
{
    ...
    LOG_DEBUG("%s", __func__);
    memset(&mesh_param, 0, sizeof(mesh_param));
    mesh_param.provisioner_prov_link_open.bearer = (ssv_ble_mesh_prov_bearer_t)bearer;

    btc_ble_mesh_prov_callback(&mesh_param, SSV_BLE_MESH_PROVISIONER_PROV_LINK_OPEN_EVT);
    return;
}
...
static void btc_ble_mesh_provisioner_link_close_cb(bt_mesh_prov_bearer_t bearer, u8_t reason)
{
    ...
    LOG_DEBUG("%s", __func__);
    memset(&mesh_param, 0, sizeof(mesh_param));
    mesh_param.provisioner_prov_link_close.bearer = (ssv_ble_mesh_prov_bearer_t)bearer;
    mesh_param.provisioner_prov_link_close.reason = reason;

    btc_ble_mesh_prov_callback(&mesh_param, SSV_BLE_MESH_PROVISIONER_PROV_LINK_CLOSE_EVT);
    return;
}
    ...
    u16_t netkey_idx)
{
    ...
    memcpy(mesh_param.provisioner_prov_complete.device_uuid, device_uuid, sizeof(ssv_ble_mesh_octet16_t));

    btc_ble_mesh_prov_callback(&mesh_param, SSV_BLE_MESH_PROVISIONER_PROV_COMPLETE_EVT);
    return;
}
...
static void btc_ble_mesh_heartbeat_msg_recv_cb(u8_t hops, u16_t feature)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, SSV_BLE_MESH_HEARTBEAT_MESSAGE_RECV_EVT);
    return;
}
...
static void btc_ble_mesh_lpn_cb(u16_t friend_addr, bool established)
{
    ...
    if (established) {
        ...
        act = SSV_BLE_MESH_LPN_FRIENDSHIP_ESTABLISH_EVT;
    } else {
        mesh_param.lpn_friendship_terminate.friend_addr = friend_addr;
        act = SSV_BLE_MESH_LPN_FRIENDSHIP_TERMINATE_EVT;
    }
...
{
    ssv_ble_mesh_prov_cb_param_t mesh_param = {0};
    ...
    btc_ble_mesh_prov_callback(&mesh_param, SSV_BLE_MESH_PROXY_CLIENT_RECV_ADV_PKT_EVT);
    return;
}
        ...
        u8_t conn_handle, u16_t net_idx)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, SSV_BLE_MESH_PROXY_CLIENT_CONNECTED_EVT);
    return;
}
        ...
        u8_t conn_handle, u16_t net_idx, u8_t reason)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, SSV_BLE_MESH_PROXY_CLIENT_DISCONNECTED_EVT);
    return;
}
        ...
        u16_t src, u16_t net_idx, u8_t filter_type, u16_t list_size)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, SSV_BLE_MESH_PROXY_CLIENT_RECV_FILTER_STATUS_EVT);
    return;
}
...
int btc_ble_mesh_client_model_init(ssv_ble_mesh_model_t *model)
{
    ...
    ssv_ble_mesh_model_op_t *op = model->op;
    while (op != NULL && op->opcode != 0) {
        op->param_cb = (ssv_ble_mesh_cb_t)btc_ble_mesh_client_model_op_cb;
        op++;
    }
...
{
    return (ssv_ble_mesh_elem_t *)bt_mesh_elem_find(addr);
}
...
{
    return (ssv_ble_mesh_model_t *)bt_mesh_model_find_vnd((struct bt_mesh_elem *)elem, company, id);
}

ssv_ble_mesh_model_t *btc_ble_mesh_model_find(const ssv_ble_mesh_elem_t *elem, uint16_t id)
{
    return (ssv_ble_mesh_model_t *)bt_mesh_model_find((struct bt_mesh_elem *)elem, id);
}

const ssv_ble_mesh_comp_t *btc_ble_mesh_comp_get(void)
{
    return (const ssv_ble_mesh_comp_t *)bt_mesh_comp_get();
}
...
#if CONFIG_BLE_MESH_OTHER_MODEL_EN
...
#endif
static void btc_ble_mesh_model_op_add(ssv_ble_mesh_model_t *model)
{
    ssv_ble_mesh_model_op_t *op = NULL;
    ...
    case BLE_MESH_MODEL_ID_CFG_SRV: {
        model->op = (ssv_ble_mesh_model_op_t *)bt_mesh_cfg_srv_op;
    ...
    case BLE_MESH_MODEL_ID_CFG_CLI: {
        model->op = (ssv_ble_mesh_model_op_t *)bt_mesh_cfg_cli_op;
    ...
    case BLE_MESH_MODEL_ID_HEALTH_SRV: {
        model->op = (ssv_ble_mesh_model_op_t *)bt_mesh_health_srv_op;
    ...
    case BLE_MESH_MODEL_ID_HEALTH_CLI: {
        model->op = (ssv_ble_mesh_model_op_t *)bt_mesh_health_cli_op;
    ...
    case BLE_MESH_MODEL_ID_GEN_ONOFF_CLI: {
        model->op = ((ssv_ble_mesh_model_op_t *)gen_onoff_cli_op);
    ...
    case BLE_MESH_MODEL_ID_GEN_ONOFF_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)gen_onoff_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
#if 0
    case BLE_MESH_MODEL_ID_GEN_LEVEL_CLI: {
        model->op = ((ssv_ble_mesh_model_op_t *)gen_level_cli_op);
    ...
    case BLE_MESH_MODEL_ID_GEN_DEF_TRANS_TIME_CLI: {
        model->op = ((ssv_ble_mesh_model_op_t *)gen_def_trans_time_cli_op);
    ...
    case BLE_MESH_MODEL_ID_GEN_POWER_ONOFF_CLI: {
        model->op = ((ssv_ble_mesh_model_op_t *)gen_power_onoff_cli_op);
    ...
    case BLE_MESH_MODEL_ID_GEN_POWER_LEVEL_CLI: {
        model->op = ((ssv_ble_mesh_model_op_t *)gen_power_level_cli_op);
    ...
    case BLE_MESH_MODEL_ID_GEN_BATTERY_CLI: {
        model->op = ((ssv_ble_mesh_model_op_t *)gen_battery_cli_op);
    ...
    case BLE_MESH_MODEL_ID_GEN_LOCATION_CLI: {
        model->op = ((ssv_ble_mesh_model_op_t *)gen_location_cli_op);
    ...
    case BLE_MESH_MODEL_ID_GEN_PROP_CLI: {
        model->op = ((ssv_ble_mesh_model_op_t *)gen_property_cli_op);
    ...
    case BLE_MESH_MODEL_ID_LIGHT_LIGHTNESS_CLI: {
        model->op = ((ssv_ble_mesh_model_op_t *)light_lightness_cli_op);
    ...
    case BLE_MESH_MODEL_ID_LIGHT_CTL_CLI: {
        model->op = ((ssv_ble_mesh_model_op_t *)light_ctl_cli_op);
    ...
    case BLE_MESH_MODEL_ID_LIGHT_HSL_CLI: {
        model->op = ((ssv_ble_mesh_model_op_t *)light_hsl_cli_op);
    ...
    case BLE_MESH_MODEL_ID_LIGHT_XYL_CLI: {
        model->op = ((ssv_ble_mesh_model_op_t *)light_xyl_cli_op);
    ...
    case BLE_MESH_MODEL_ID_LIGHT_LC_CLI: {
        model->op = ((ssv_ble_mesh_model_op_t *)light_lc_cli_op);
    ...
    case BLE_MESH_MODEL_ID_SENSOR_CLI: {
        model->op = ((ssv_ble_mesh_model_op_t *)sensor_cli_op);
    ...
    case BLE_MESH_MODEL_ID_TIME_CLI: {
        model->op = ((ssv_ble_mesh_model_op_t *)time_cli_op);
    ...
    case BLE_MESH_MODEL_ID_SCENE_CLI: {
        model->op = ((ssv_ble_mesh_model_op_t *)scene_cli_op);
    ...
    case BLE_MESH_MODEL_ID_SCHEDULER_CLI: {
        model->op = ((ssv_ble_mesh_model_op_t *)scheduler_cli_op);
    ...
    case BLE_MESH_MODEL_ID_GEN_LEVEL_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)gen_level_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_DEF_TRANS_TIME_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)gen_def_trans_time_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_POWER_ONOFF_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)gen_power_onoff_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_POWER_ONOFF_SETUP_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)gen_power_onoff_setup_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_POWER_LEVEL_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)gen_power_level_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_POWER_LEVEL_SETUP_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)gen_power_level_setup_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_BATTERY_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)gen_battery_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_LOCATION_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)gen_location_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_USER_PROP_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)gen_user_prop_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_ADMIN_PROP_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)gen_admin_prop_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_MANUFACTURER_PROP_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)gen_manu_prop_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_CLIENT_PROP_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)gen_client_prop_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_GEN_LOCATION_SETUP_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)gen_location_setup_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_LIGHTNESS_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)light_lightness_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_LIGHTNESS_SETUP_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)light_lightness_setup_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_CTL_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)light_ctl_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_CTL_SETUP_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)light_ctl_setup_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_CTL_TEMP_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)light_ctl_temp_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_HSL_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)light_hsl_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_HSL_HUE_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)light_hsl_hue_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_HSL_SAT_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)light_hsl_sat_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_HSL_SETUP_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)light_hsl_setup_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_XYL_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)light_xyl_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_XYL_SETUP_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)light_xyl_setup_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_LC_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)light_lc_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_LIGHT_LC_SETUP_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)light_lc_setup_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_TIME_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)time_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_TIME_SETUP_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)time_setup_srv_op;
        if (model->pub) {
    ...
    case BLE_MESH_MODEL_ID_SCENE_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)scene_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_SCENE_SETUP_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)scene_setup_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_SCHEDULER_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)scheduler_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_SCHEDULER_SETUP_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)scheduler_setup_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_SENSOR_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)sensor_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
    case BLE_MESH_MODEL_ID_SENSOR_SETUP_SRV:
        model->op = (ssv_ble_mesh_model_op_t *)sensor_setup_srv_op;
        if (model->pub) {
            model->pub->update = (ssv_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
        break;
...
add_model_op:
    ...
    op = model->op;
    while (op != NULL && op->opcode != 0) {
        op->param_cb = (ssv_ble_mesh_cb_t)btc_ble_mesh_server_model_op_cb;
        op++;
    }
    return;
}
...
void btc_ble_mesh_prov_call_handler(btc_msg_t *msg)
{
    ...
    case BTC_BLE_MESH_ACT_MESH_INIT: {
        ...
        for (int i = 0; i < arg->mesh_init.comp->element_count; i++) {
            ssv_ble_mesh_elem_t *elem = &arg->mesh_init.comp->elements[i];
            /* For SIG models */
            for (int j = 0; j < elem->sig_model_count; j++) {
                ssv_ble_mesh_model_t *sig_model = &elem->sig_models[j];
            ...
            for (int k = 0; k < elem->vnd_model_count; k++) {
                ssv_ble_mesh_model_t *vnd_model = &elem->vnd_models[k];
...
#if CONFIG_BLE_MESH_NODE
        arg->mesh_init.prov->oob_pub_key_cb = (ssv_ble_mesh_cb_t)btc_ble_mesh_oob_pub_key_cb;
        arg->mesh_init.prov->output_num_cb = (ssv_ble_mesh_cb_t)btc_ble_mesh_output_number_cb;
        arg->mesh_init.prov->output_str_cb = (ssv_ble_mesh_cb_t)btc_ble_mesh_output_string_cb;
        arg->mesh_init.prov->input_cb = (ssv_ble_mesh_cb_t)btc_ble_mesh_input_cb;
        arg->mesh_init.prov->link_open_cb = (ssv_ble_mesh_cb_t)btc_ble_mesh_link_open_cb;
        arg->mesh_init.prov->link_close_cb = (ssv_ble_mesh_cb_t)btc_ble_mesh_link_close_cb;
        arg->mesh_init.prov->complete_cb = (ssv_ble_mesh_cb_t)btc_ble_mesh_complete_cb;
        arg->mesh_init.prov->reset_cb = (ssv_ble_mesh_cb_t)btc_ble_mesh_reset_cb;
#if CONFIG_BLE_MESH_LOW_POWER
...
#endif /* CONFIG_BLE_MESH_NODE */
#if CONFIG_BLE_MESH_PROVISIONER
        arg->mesh_init.prov->provisioner_prov_read_oob_pub_key = (ssv_ble_mesh_cb_t)btc_ble_mesh_provisioner_prov_read_oob_pub_key_cb;
        arg->mesh_init.prov->provisioner_prov_input = (ssv_ble_mesh_cb_t)btc_ble_mesh_provisioner_prov_input_cb;
        arg->mesh_init.prov->provisioner_prov_output = (ssv_ble_mesh_cb_t)btc_ble_mesh_provisioner_prov_output_cb;
        arg->mesh_init.prov->provisioner_link_open = (ssv_ble_mesh_cb_t)btc_ble_mesh_provisioner_link_open_cb;
        arg->mesh_init.prov->provisioner_link_close = (ssv_ble_mesh_cb_t)btc_ble_mesh_provisioner_link_close_cb;
        arg->mesh_init.prov->provisioner_prov_comp = (ssv_ble_mesh_cb_t)btc_ble_mesh_provisioner_prov_complete_cb;
    ...
    case BTC_BLE_MESH_ACT_PROV_ENABLE:
        ...
        act = SSV_BLE_MESH_NODE_PROV_ENABLE_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROV_DISABLE:
        ...
        act = SSV_BLE_MESH_NODE_PROV_DISABLE_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_NODE_RESET:
        ...
        bt_mesh_reset();
        return;
    case BTC_BLE_MESH_ACT_NODE_SUSPEND:
        LOG_DEBUG("%s, BTC_BLE_MESH_ACT_NODE_SUSPEND", __func__);
        bt_mesh_suspend();
        return;
    case BTC_BLE_MESH_ACT_NODE_RESUME:
        LOG_DEBUG("%s, BTC_BLE_MESH_ACT_NODE_RESUME", __func__);
        bt_mesh_resume();
        return;
    case BTC_BLE_MESH_ACT_SET_OOB_PUB_KEY:
        act = SSV_BLE_MESH_NODE_PROV_SET_OOB_PUB_KEY_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_SET_DEVICE_NAME:
        act = SSV_BLE_MESH_NODE_SET_UNPROV_DEV_NAME_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_READ_OOB_PUB_KEY:
        act = SSV_BLE_MESH_PROVISIONER_PROV_READ_OOB_PUB_KEY_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_INPUT_STR:
        act = SSV_BLE_MESH_PROVISIONER_PROV_INPUT_STRING_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_INPUT_NUM:
        act = SSV_BLE_MESH_PROVISIONER_PROV_INPUT_NUMBER_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_ENABLE:
        act = SSV_BLE_MESH_PROVISIONER_PROV_ENABLE_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_DISABLE:
        act = SSV_BLE_MESH_PROVISIONER_PROV_DISABLE_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_DEV_ADD: {
        ...
        memset(&add_dev, 0, sizeof(add_dev));
        ...
        act = SSV_BLE_MESH_PROVISIONER_ADD_UNPROV_DEV_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_DEV_DEL: {
        ...
        memset(&del_dev, 0, sizeof(del_dev));
        ...
        act = SSV_BLE_MESH_PROVISIONER_DELETE_DEV_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_SET_DEV_UUID_MATCH:
        act = SSV_BLE_MESH_PROVISIONER_SET_DEV_UUID_MATCH_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_SET_PROV_DATA_INFO: {
        struct bt_mesh_prov_data_info info;
        ...
        act = SSV_BLE_MESH_PROVISIONER_SET_PROV_DATA_INFO_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_SET_NODE_NAME:
        act = SSV_BLE_MESH_PROVISIONER_SET_NODE_NAME_COMP_EVT;
        ...
        if (param.provisioner_set_node_name_comp.err_code) {
            param.provisioner_set_node_name_comp.node_index = SSV_BLE_MESH_INVALID_NODE_INDEX;
        } else {
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_SET_LOCAL_APP_KEY: {
        ...
        act = SSV_BLE_MESH_PROVISIONER_ADD_LOCAL_APP_KEY_COMP_EVT;
        ...
        if (param.provisioner_add_app_key_comp.err_code) {
            param.provisioner_add_app_key_comp.app_idx = SSV_BLE_MESH_KEY_UNUSED;
        } else {
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_BIND_LOCAL_MOD_APP:
        act = SSV_BLE_MESH_PROVISIONER_BIND_APP_KEY_TO_MODEL_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_ADD_LOCAL_NET_KEY: {
        ...
        act = SSV_BLE_MESH_PROVISIONER_ADD_LOCAL_NET_KEY_COMP_EVT;
        ...
        if (param.provisioner_add_net_key_comp.err_code) {
            param.provisioner_add_net_key_comp.net_idx = SSV_BLE_MESH_KEY_UNUSED;
        } else {
    ...
    case BTC_BLE_MESH_ACT_SET_FAST_PROV_INFO:
        act = SSV_BLE_MESH_SET_FAST_PROV_INFO_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_SET_FAST_PROV_ACTION:
        act = SSV_BLE_MESH_SET_FAST_PROV_ACTION_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROXY_CLIENT_DISCONNECT:
        act = SSV_BLE_MESH_PROXY_CLIENT_DISCONNECT_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROXY_CLIENT_SET_FILTER_TYPE: {
        ...
        act = SSV_BLE_MESH_PROXY_CLIENT_SET_FILTER_TYPE_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROXY_CLIENT_ADD_FILTER_ADDR: {
        ...
        act = SSV_BLE_MESH_PROXY_CLIENT_ADD_FILTER_ADDR_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROXY_CLIENT_REMOVE_FILTER_ADDR: {
        ...
        act = SSV_BLE_MESH_PROXY_CLIENT_REMOVE_FILTER_ADDR_COMP_EVT;
...
{
    ssv_ble_mesh_prov_cb_param_t *param = NULL;
    ...
    param = (ssv_ble_mesh_prov_cb_param_t *)(msg->arg);

    if (msg->act < SSV_BLE_MESH_PROV_EVT_MAX) {
...
void btc_ble_mesh_model_call_handler(btc_msg_t *msg)
{
    ...
    case BTC_BLE_MESH_ACT_SERVER_MODEL_SEND: {
        ...
        err = bt_mesh_model_send_ssv(arg->model_send.opcode,
                                 (struct bt_mesh_model *)arg->model_send.model,
...
{
    ssv_ble_mesh_model_cb_param_t *param = NULL;
    ...
    param = (ssv_ble_mesh_model_cb_param_t *)(msg->arg);

    if (msg->act < SSV_BLE_MESH_MODEL_EVT_MAX) {

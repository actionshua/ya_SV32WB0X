...
static inline void btc_ble_mesh_time_scene_client_cb_to_app(ssv_ble_mesh_time_scene_client_cb_event_t event,
        ssv_ble_mesh_time_scene_client_cb_param_t *param)
{
    ssv_ble_mesh_time_scene_client_cb_t btc_ble_mesh_cb =
        (ssv_ble_mesh_time_scene_client_cb_t)btc_profile_cb_get(BTC_PID_TIME_SCENE_CLIENT);
    if (btc_ble_mesh_cb) {
...
void btc_ble_mesh_time_scene_client_arg_deep_copy(btc_msg_t *msg, void *p_dest, void *p_src)
{
    ...
    case BTC_BLE_MESH_ACT_TIME_SCENE_CLIENT_GET_STATE: {
        dst->time_scene_client_get_state.params = (ssv_ble_mesh_client_common_param_t *)osi_malloc(sizeof(ssv_ble_mesh_client_common_param_t));
        dst->time_scene_client_get_state.get_state = (ssv_ble_mesh_time_scene_client_get_state_t *)osi_malloc(sizeof(ssv_ble_mesh_time_scene_client_get_state_t));
        if (dst->time_scene_client_get_state.params && dst->time_scene_client_get_state.get_state) {
            ...
            memcpy(dst->time_scene_client_get_state.get_state, src->time_scene_client_get_state.get_state,
                   sizeof(ssv_ble_mesh_time_scene_client_get_state_t));
        } else {
    ...
    case BTC_BLE_MESH_ACT_TIME_SCENE_CLIENT_SET_STATE: {
        dst->time_scene_client_set_state.params = (ssv_ble_mesh_client_common_param_t *)osi_malloc(sizeof(ssv_ble_mesh_client_common_param_t));
        dst->time_scene_client_set_state.set_state = (ssv_ble_mesh_time_scene_client_set_state_t *)osi_malloc(sizeof(ssv_ble_mesh_time_scene_client_set_state_t));
        if (dst->time_scene_client_set_state.params && dst->time_scene_client_set_state.set_state) {
            ...
            memcpy(dst->time_scene_client_set_state.set_state, src->time_scene_client_set_state.set_state,
                   sizeof(ssv_ble_mesh_time_scene_client_set_state_t));
        } else {
            LOG_ERROR("%s, Failed to allocate memory, act %d", __func__, msg->act);
        }
        break;
...
{
    ssv_ble_mesh_time_scene_client_cb_param_t *p_dest_data = (ssv_ble_mesh_time_scene_client_cb_param_t *)p_dest;
    ssv_ble_mesh_time_scene_client_cb_param_t *p_src_data = (ssv_ble_mesh_time_scene_client_cb_param_t *)p_src;
    u16_t length;
    ...
    switch (msg->act) {
    case SSV_BLE_MESH_TIME_SCENE_CLIENT_GET_STATE_EVT:
    case SSV_BLE_MESH_TIME_SCENE_CLIENT_SET_STATE_EVT:
    case SSV_BLE_MESH_TIME_SCENE_CLIENT_PUBLISH_EVT:
        if (p_src_data->params) {
            switch (p_src_data->params->opcode) {
            case SSV_BLE_MESH_MODEL_OP_SCENE_STORE:
            case SSV_BLE_MESH_MODEL_OP_SCENE_REGISTER_GET:
            case SSV_BLE_MESH_MODEL_OP_SCENE_DELETE:
            case SSV_BLE_MESH_MODEL_OP_SCENE_REGISTER_STATUS:
    ...
    case SSV_BLE_MESH_TIME_SCENE_CLIENT_TIMEOUT_EVT:
        break;
    default:
        break;
    }
...
{
    ssv_ble_mesh_time_scene_client_cb_param_t *arg = NULL;
    ...
    arg = (ssv_ble_mesh_time_scene_client_cb_param_t *)(msg->arg);
...
static void btc_ble_mesh_time_scene_client_callback(ssv_ble_mesh_time_scene_client_cb_param_t *cb_params, uint8_t act)
{
    btc_msg_t msg = {0};
    ...
    btc_transfer_context(&msg, cb_params,
                         sizeof(ssv_ble_mesh_time_scene_client_cb_param_t), btc_ble_mesh_time_scene_client_copy_req_data);
}
...
{
    ssv_ble_mesh_time_scene_client_cb_param_t cb_params = {0};
    ...
    case BTC_BLE_MESH_EVT_TIME_SCENE_CLIENT_GET_STATE:
        act = SSV_BLE_MESH_TIME_SCENE_CLIENT_GET_STATE_EVT;
        break;
    case BTC_BLE_MESH_EVT_TIME_SCENE_CLIENT_SET_STATE:
        act = SSV_BLE_MESH_TIME_SCENE_CLIENT_SET_STATE_EVT;
        break;
    case BTC_BLE_MESH_EVT_TIME_SCENE_CLIENT_PUBLISH:
        act = SSV_BLE_MESH_TIME_SCENE_CLIENT_PUBLISH_EVT;
        break;
    case BTC_BLE_MESH_EVT_TIME_SCENE_CLIENT_TIMEOUT:
        act = SSV_BLE_MESH_TIME_SCENE_CLIENT_TIMEOUT_EVT;
        break;
    default:
...
void btc_ble_mesh_time_scene_client_call_handler(btc_msg_t *msg)
{
    ...
    ssv_ble_mesh_time_scene_client_cb_param_t cb = {0};
    ...
    case BTC_BLE_MESH_ACT_TIME_SCENE_CLIENT_GET_STATE: {
        ...
        if (cb.error_code) {
            ...
            btc_ble_mesh_time_scene_client_callback(&cb, SSV_BLE_MESH_TIME_SCENE_CLIENT_GET_STATE_EVT);
        }
        break;
    }
    case BTC_BLE_MESH_ACT_TIME_SCENE_CLIENT_SET_STATE: {
        ...
        if (cb.error_code) {
            /* If send failed, callback error_code to app layer immediately */
            btc_ble_mesh_time_scene_client_callback(&cb, SSV_BLE_MESH_TIME_SCENE_CLIENT_SET_STATE_EVT);
        }
        break;
    }
    default:
...
{
    ssv_ble_mesh_time_scene_client_cb_param_t *param = NULL;
    ...
    param = (ssv_ble_mesh_time_scene_client_cb_param_t *)(msg->arg);

    if (msg->act < SSV_BLE_MESH_TIME_SCENE_CLIENT_EVT_MAX) {
...
static inline void btc_ble_mesh_time_scene_server_cb_to_app(
    ssv_ble_mesh_time_scene_server_cb_event_t event,
    ssv_ble_mesh_time_scene_server_cb_param_t *param)
{
    ssv_ble_mesh_time_scene_server_cb_t btc_ble_mesh_cb =
        (ssv_ble_mesh_time_scene_server_cb_t)btc_profile_cb_get(BTC_PID_TIME_SCENE_SERVER);
    if (btc_ble_mesh_cb) {
        btc_ble_mesh_cb(event, param);
    }
}

static void btc_ble_mesh_time_scene_server_callback(ssv_ble_mesh_time_scene_server_cb_param_t *cb_params, uint8_t act)
{
    btc_msg_t msg = {0};
    ...
    btc_transfer_context(
        &msg, cb_params, sizeof(ssv_ble_mesh_time_scene_server_cb_param_t), NULL);
}
...
void bt_mesh_time_scene_server_cb_evt_to_btc(u8_t evt_type,
        ...
        const u8_t *val, size_t len)
{
    ssv_ble_mesh_time_scene_server_cb_param_t cb_params = {0};
    size_t length;
    uint8_t act;
    ...
    case BTC_BLE_MESH_EVT_TIME_SCENE_SERVER_STATE_CHANGE:
        act = SSV_BLE_MESH_TIME_SCENE_SERVER_STATE_CHANGE_EVT;
        break;
    case BTC_BLE_MESH_EVT_TIME_SCENE_SERVER_RECV_GET_MSG:
        act = SSV_BLE_MESH_TIME_SCENE_SERVER_RECV_GET_MSG_EVT;
        break;
    case BTC_BLE_MESH_EVT_TIME_SCENE_SERVER_RECV_SET_MSG:
        act = SSV_BLE_MESH_TIME_SCENE_SERVER_RECV_SET_MSG_EVT;
        break;
    case BTC_BLE_MESH_EVT_TIME_SCENE_SERVER_RECV_STATUS_MSG:
        act = SSV_BLE_MESH_TIME_SCENE_SERVER_RECV_STATUS_MSG_EVT;
        break;
    default:
...
{
    ssv_ble_mesh_time_scene_server_cb_param_t *param = NULL;
    ...
    param = (ssv_ble_mesh_time_scene_server_cb_param_t *)(msg->arg);

    if (msg->act < SSV_BLE_MESH_TIME_SCENE_SERVER_EVT_MAX) {

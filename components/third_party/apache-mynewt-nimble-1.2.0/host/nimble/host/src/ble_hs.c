...
#define BLE_HS_SYNC_RETRY_TIMEOUT_MS    3000 /* ms werner change from 100 to 3000*/
...
void ble_mqueue_showinfo(struct ble_mqueue *mq);

void ble_mq_showinfo(void)
{
    ble_mqueue_showinfo(&ble_hs_rx_q);
}
...
ble_hs_rx_data(struct os_mbuf *om, void *arg)
{
    ...
    /*if (om->om_len > 20) {
        outom = ble_mqueue_get(&ble_hs_rx_q);
        printf("%s b om_len %d\n", __func__, outom->om_len);
    }*/
    return 0;
}

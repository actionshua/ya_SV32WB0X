...
#define DEV_UUID_SIZE 16
static uint8_t dev_uuid[DEV_UUID_SIZE] = {0};
...
blemesh_on_sync(void)
{
    ...
    memcpy(dev_uuid, MYNEWT_VAL(BLE_MESH_DEV_UUID), DEV_UUID_SIZE);
    ...
    //shell_register_default_module("mesh");//todo
#endif

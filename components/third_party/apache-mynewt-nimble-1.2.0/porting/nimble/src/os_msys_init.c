...
ATTRIBUTE_SECTION_MESH_BLE static os_membuf_t os_msys_init_1_data[SYSINIT_MSYS_1_MEMPOOL_SIZE];
ATTRIBUTE_SECTION_MESH_BLE static struct os_mbuf_pool os_msys_init_1_mbuf_pool;
ATTRIBUTE_SECTION_MESH_BLE static struct os_mempool os_msys_init_1_mempool;
#endif

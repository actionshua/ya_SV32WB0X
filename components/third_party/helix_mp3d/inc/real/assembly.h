...
{
#ifdef __NDS32_EXT_DSP__
    return NDS_DSP_ABS(x);
#else
    return NDS_ISA_ABS(x);
#endif
}
static __inline int CLZ(int x)
{
#ifdef __NDS32_EXT_DSP__
    return NDS_DSP_CLZ(x);
#else
    return NDS_ISA_CLZ(x);
#endif
}

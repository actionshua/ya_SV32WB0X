...
#if 0
void PolyphaseStereo(short *pcm, int *vbuf, const int *coefBase) __attribute__ (( noinline ));
static short ClipToShort(int x, int fracBits) __attribute__ (( noinline ));
void ps0(short *pcm, int *vbuf, const int *coefBase) __attribute__ (( noinline ));
void ps1(short *pcm, int *vbuf, const int *coefBase) __attribute__ (( noinline ));
#endif
...
void ps0(short *pcm, int *vbuf, const int *coefBase)
{
    const int *coef;
    int *vb1;
    int vLo, vHi, c1, c2;
...
void ps1(short *pcm, int *vbuf, const int *coefBase)
{
    const int *coef;
    int *vb1;
    int vLo, vHi, c1, c2;

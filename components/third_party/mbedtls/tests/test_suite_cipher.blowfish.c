...
int static hexcmp( uint8_t * a, uint8_t * b, uint32_t a_len, uint32_t b_len )
{
    int ret = 0;
    uint32_t i = 0;
...
static void test_mbedtls_cipher_list(  )
{
...
static void test_cipher_invalid_param_unconditional( )
{
...
#line 147 "suites/test_suite_cipher.function"
static void test_cipher_invalid_param_conditional( )
{
    mbedtls_cipher_context_t valid_ctx;
...
#line 487 "suites/test_suite_cipher.function"
static void test_cipher_special_behaviours(  )
{
...
#endif /* MBEDTLS_AES_C */
#line 536 "suites/test_suite_cipher.function"
...
#line 661 "suites/test_suite_cipher.function"
...
#line 713 "suites/test_suite_cipher.function"
static void test_dec_empty_buf(  )
{
    unsigned char key[32];
    unsigned char iv[16];
...
#line 763 "suites/test_suite_cipher.function"
...
#line 877 "suites/test_suite_cipher.function"
...
#if defined(MBEDTLS_CIPHER_MODE_AEAD)
#line 935 "suites/test_suite_cipher.function"
...
#line 1004 "suites/test_suite_cipher.function"
...
#if defined(MBEDTLS_CIPHER_MODE_WITH_PADDING)
#line 1042 "suites/test_suite_cipher.function"
static void test_test_vec_crypt( int cipher_id, int operation, char *hex_key,
...
#endif /* MBEDTLS_CIPHER_MODE_WITH_PADDING */
#if defined(MBEDTLS_CIPHER_MODE_WITH_PADDING)
#line 1091 "suites/test_suite_cipher.function"
...
#endif /* MBEDTLS_CIPHER_MODE_WITH_PADDING */
#if defined(MBEDTLS_CIPHER_MODE_CBC)
#line 1110 "suites/test_suite_cipher.function"
...
static int execute_tests( int argc , const char ** argv )
{
    ...
    const char *default_filename = "/cipher.blowfish.datax";

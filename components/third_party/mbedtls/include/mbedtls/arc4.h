...
#define SSV_MBEDTLS_ERR_ARC4_HW_ACCEL_FAILED                  -0x0019  /**< ARC4 hardware accelerator failed. */
 ...
 *
 */
typedef struct ssv_mbedtls_arc4_context
{
    int x;                      /*!< permutation index */
    int y;                      /*!< permutation index */
    unsigned char m[256];       /*!< permutation table */
}
ssv_mbedtls_arc4_context;
...
#ifdef MBEDTLS_EN
#define MBEDTLS_ERR_ARC4_HW_ACCEL_FAILED SSV_MBEDTLS_ERR_ARC4_HW_ACCEL_FAILED
#if !defined(MBEDTLS_ARC4_ALT)
#define mbedtls_arc4_context ssv_mbedtls_arc4_context
#endif

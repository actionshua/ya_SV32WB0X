...
typedef struct mbedtls_rsa_context
{
    ...
    ssv_mbedtls_mpi N;              /*!<  The public modulus. */
    ssv_mbedtls_mpi E;              /*!<  The public exponent. */

    ssv_mbedtls_mpi D;              /*!<  The private exponent. */
    ssv_mbedtls_mpi P;              /*!<  The first prime factor. */
    ssv_mbedtls_mpi Q;              /*!<  The second prime factor. */

    ssv_mbedtls_mpi DP;             /*!<  <code>D % (P - 1)</code>. */
    ssv_mbedtls_mpi DQ;             /*!<  <code>D % (Q - 1)</code>. */
    ssv_mbedtls_mpi QP;             /*!<  <code>1 / (Q % P)</code>. */

    ssv_mbedtls_mpi RN;             /*!<  cached <code>R^2 mod N</code>. */

    ssv_mbedtls_mpi RP;             /*!<  cached <code>R^2 mod P</code>. */
    ssv_mbedtls_mpi RQ;             /*!<  cached <code>R^2 mod Q</code>. */

    ssv_mbedtls_mpi Vi;             /*!<  The cached blinding value. */
    ssv_mbedtls_mpi Vf;             /*!<  The cached un-blinding value. */
...
int mbedtls_rsa_import( mbedtls_rsa_context *ctx,
                        ...
                        const ssv_mbedtls_mpi *P, const ssv_mbedtls_mpi *Q,
                        const ssv_mbedtls_mpi *D, const ssv_mbedtls_mpi *E );
...
int mbedtls_rsa_export( const mbedtls_rsa_context *ctx,
                        ssv_mbedtls_mpi *N, ssv_mbedtls_mpi *P, ssv_mbedtls_mpi *Q,
                        ssv_mbedtls_mpi *D, ssv_mbedtls_mpi *E );
...
int mbedtls_rsa_export_crt( const mbedtls_rsa_context *ctx,
                            ssv_mbedtls_mpi *DP, ssv_mbedtls_mpi *DQ, ssv_mbedtls_mpi *QP );
...
int mbedtls_rsa_rsassa_pss_verify_ext( mbedtls_rsa_context *ctx,
                               ...
                               unsigned int hashlen,
                               const unsigned char *hash,
                               ssv_mbedtls_md_type_t mgf1_hash_id,

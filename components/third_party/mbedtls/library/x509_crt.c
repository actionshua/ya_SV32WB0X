...
cleanup:
    closedir( dir );
#else
    if(strcmp(path, "/data/dir1")== 0) {
        char *test_file1 = "/data/dir1/test-ca.crt";
        strcpy(entry_name, test_file1);
        t_ret = mbedtls_x509_crt_parse_file( chain, entry_name );
        if( t_ret < 0 )
            ret++;
        else
            ret += t_ret;
    } else if(strcmp(path, "/data/dir2")== 0) {
        char *test_file1 = "/data/dir2/test-ca.crt";
        char *test_file2 = "/data/dir2/test-ca2.crt";
        strcpy(entry_name, test_file1);
        t_ret = mbedtls_x509_crt_parse_file( chain, entry_name );
        if( t_ret < 0 )
            ret++;
            ...
            ret += t_ret;
        strcpy(entry_name, test_file2);
        t_ret = mbedtls_x509_crt_parse_file( chain, entry_name );
        if( t_ret < 0 )
            ret++;
        else
            ret += t_ret;
    } else if(strcmp(path, "/data/dir3")== 0) {
        char *test_file1 = "/data/dir3/test-ca.crt";
        char *test_file2 = "/data/dir3/test-ca2.crt";
        char *test_file3 = "/data/dir3/Readme";
        strcpy(entry_name, test_file1);
        t_ret = mbedtls_x509_crt_parse_file( chain, entry_name );
        if( t_ret < 0 )
            ret++;

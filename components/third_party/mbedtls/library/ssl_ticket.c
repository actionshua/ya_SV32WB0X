                               ...
                               unsigned char index )
{
    ...
    key->generation_time = (uint32_t) (mbedtls_time_t)psGetTime(NULL, NULL);//mbedtls_time( NULL );
#endif
...
static int ssl_ticket_update_keys( mbedtls_ssl_ticket_context *ctx )
{
    ...
    {
        uint32_t current_time = (uint32_t) (mbedtls_time_t)psGetTime(NULL, NULL);//mbedtls_time( NULL );
                              ...
                              size_t len )
{
...
#if defined(MBEDTLS_HAVE_TIME)
    {
        ...
        mbedtls_time_t current_time = (mbedtls_time_t)psGetTime(NULL, NULL);//mbedtls_time( NULL );

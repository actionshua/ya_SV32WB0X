...
void kws_nn_init_with_buffer(short* audio_data_buffer);
void kws_nn_deinit();
...
extern short* kws_audio_buffer;
extern signed char *kws_output;
extern signed char *kws_predictions;
extern signed char *kws_averaged_output;

...
int Es8311Init();
void Es8311Uninit();
int Es8311GetRef(bool flag);
int Es7243Init(void);

int Es7243ReadReg(uint8_t regAdd);

int Es8311ConfigFmt(CodecModule mode, CodecI2SFmt fmt);
int Es8311I2sConfigClock(CodecI2sClock cfg);
int Es8311SetBitsPerSample(CodecModule mode, BitsLength bitPerSample);

int Es8311Start(CodecModule mode);
int Es8311Stop(CodecModule mode);

...
/* ES8388 address */
#define ES8388_ADDR 0x10  // 0x11:CE=1;0x20:CE=0
...
int Es8388ConfigFmt(CodecModule mode, CodecI2SFmt fmt);
int Es8388I2sConfigClock(CodecI2sClock cfg);
int Es8388SetBitsPerSample(CodecModule mode, BitsLength bitPerSample);

int Es8388Start(CodecModule mode);
int Es8388Stop(CodecModule mode);

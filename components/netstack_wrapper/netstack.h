...
int netstack_input(char *ifname, void *data, u32 len) ATTRIBUTE_SECTION_FAST_L3STACK;

// Transfer netstack packet to L2
int netstack_output(char *name, void *data, u32 len) ATTRIBUTE_SECTION_FAST_L3STACK;

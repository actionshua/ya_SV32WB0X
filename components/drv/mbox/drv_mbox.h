...
s32 drv_mailbox_cpu_ff(u32 pktmsg, u32 hw_number) ATTRIBUTE_SECTION_FAST_L2STACK;
s32 drv_mailbox_cpu_next(u32 pktmsg);

#define drv_mailbox_send(hw_number, pktmsg) drv_mailbox_cpu_ff(pktmsg,hw_number)
#define drv_mailbox_next(pktmsg)            drv_mailbox_cpu_next(pktmsg)

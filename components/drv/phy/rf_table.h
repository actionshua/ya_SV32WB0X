...
#define RF_API_TABLE_VERSION        (0x0003) // It should be incremented after structure st_rf_table change.
...
{
    uint8_t band_gain[BLE_CHANNEL_PART_COUNT];   //0:ch1~ch2, 1:ch2~ch3, ..., 6:ch13~ch14
}SSV_PACKED_STRUCT_STRUCT;
SSV_PACKED_STRUCT_END
...
struct st_rf_table 
{
    ...
    struct st_ble_tempe_table ble_rt_config;
    struct st_ble_tempe_table ble_ht_config;
    struct st_ble_tempe_table ble_lt_config;

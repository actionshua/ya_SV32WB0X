...
void        *PBUF_MAlloc_Raw(u32 size, u32 need_header, PBuf_Type_E buf_type) ATTRIBUTE_SECTION_FAST_L2STACK;
...
s32 getpacketbuffer_ex(struct tx_pktbuf *buf, int payload_len, PBuf_Type_E buf_type) ATTRIBUTE_SECTION_FAST_L2STACK;
s32 getpacketbuffer(struct tx_pktbuf *buf, int payload_len) ATTRIBUTE_SECTION_FAST_L2STACK;
void setpacketbuf_len(u32 *buf, int payload_len) ATTRIBUTE_SECTION_FAST_L2STACK;
void PBUF_inc_cnt(void);
void PBUF_dec_cnt(void);
int PBUF_get_cnt(void);
void PBUF_reset_cnt(void);

...
CFLAGS 		+= -DSUPPORT_PERIPHERAL_TOUCH=1
endif
...
CFLAGS      += -DSUPPORT_LOG_RINGBUFFER=1 -DSUPPORT_LOG_RX_BUF_SIZE=$(SUPPORT_LOG_RX_BUF_SIZE) -DSUPPORT_LOG_TX_BUF_SIZE=$(SUPPORT_LOG_TX_BUF_SIZE)
endif

ifeq ($(strip $(SETTING_BLE_UART)),1)
CFLAGS      += -DSETTING_BLE_UART=$(SETTING_BLE_UART)
endif

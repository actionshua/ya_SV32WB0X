...
uint32_t ya_button_event_timer = 0;
uint8_t ya_button_event_enable = 0;
void ya_set_button_timing_event(void)
{
	ya_button_event_enable = 1;
	ya_button_event_timer = ya_hal_os_ticks_to_msec();
}

void ya_clear_button_timing_event(void)
{
	ya_button_event_enable = 0;
}

void ya_check_button_timing_event(void)
{
	st_ya_stripLigths_workData *pworkInfo = &ya_stripLigths_workData;
	if (ya_button_event_enable)
	{
		if (ya_timer_compare(ya_button_event_timer, ya_hal_os_ticks_to_msec(), 60*1000) == 0)
		{

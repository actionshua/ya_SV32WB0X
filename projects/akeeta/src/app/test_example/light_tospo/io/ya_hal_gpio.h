...
#define GPIO1_PIN        	GPIO_21
#define GPIO1_DIRECTION		GPIO_DIR_OUT
#define GPIO1_PULL_MODE		0

#define GPIO2_PIN        	GPIO_22
#define GPIO2_DIRECTION		GPIO_DIR_IN
#define GPIO2_PULL_MODE		0

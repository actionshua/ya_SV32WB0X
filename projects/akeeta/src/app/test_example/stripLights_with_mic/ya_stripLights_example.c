...
static void ya_start_akeeta_sdk(void)
{
	...
	test_striplight_main_para.ble_timeout = 180;
	test_striplight_main_para.ya_init_mode = BLE_CFG_MODE;
...
uint8_t ya_stripLights_example(void)
{
	int ret = -1;

...
typedef struct MQTTClient
{
    ...
    Network* ipstack;
    Timer last_sent, last_received, ping_handle;
 ...
 *  @return success code
 */
DLLExport int emq_MQTTConnect(MQTTClient* client, MQTTPacket_connectData* options);
 ...
 *  @return success code
 */
DLLExport int emq_MQTTPublish(MQTTClient* client, const char*, MQTTMessage*);

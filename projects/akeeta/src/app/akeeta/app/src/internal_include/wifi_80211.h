...
enum AUTH_TYPE_ {
    ...
    AUTH_TYPE_WPA2PSK,
    AUTH_TYPE_WPA28021X,
    AUTH_TYPE_WPAPSKWPA2PSK,
    AUTH_TYPE_MAX = AUTH_TYPE_WPAPSKWPA2PSK,
    AUTH_TYPE_INVALID = 0xff,
};
...
enum ENC_TYPE_ {
    ...
    ENC_TYPE_AES,
    ENC_TYPE_TKIPAES,
    ENC_TYPE_MAX = ENC_TYPE_TKIPAES,
    ENC_TYPE_INVALID = 0xff,
};
 ...
 */
struct wifi_80211_radiotap_header {
...
/**
 * struct wifi_80211_ht_operation - HT operation IE
 *
 * This structure is the "HT operation element" as
 * described in 802.11n-2009 7.3.2.57
 */
struct wifi_80211_ht_operation {

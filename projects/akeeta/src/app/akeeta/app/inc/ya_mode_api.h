...
/**
 * @brief This function is used to set the module to BLE mode. The module will erase all flash data and reboot.
 *
 * @return 0: sucess, -1: failed
 */
...
/**
 * @brief This function is used to set the module to idle mode when next reboot in case sniffer or ap config failed. 
 *
 * @return 0: sucess, -1: failed
 */
